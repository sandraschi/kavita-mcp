...
const BACKEND_NAME: &str = "kavita-mcp-backend.exe";
const BACKEND_PORT: u16 = 11189;
const BACKEND_TAG: &str = "kavita-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "KAVITA_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 11189",
    ...
    Ok(format!("Backend starting on port 11189"))
}
